...
/jobe apply-all                     Process entire apply queue via Camoufox stealth auto-apply (default); --top N, --paste fallback, --headless
...
- install scripts copy CLAUDE.md, all lib files (including `lib/apply/`), all modes, all agents
