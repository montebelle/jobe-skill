 ...
 * industry-wide; John's personal experience converts at a different rate.
 * For ghost-scoring purposes, what matters is the relative comparison
 * between companies: a company where John has applied 5 times with 0
...
function computeCompanyStats() {
  ...
  for (const [slug, stats] of byCompany) {
    out[slug] = {
      ...stats,
      // Require a meaningful sample before trusting John's personal conversion
