 ...
 *   3. MinHash LSH fuzzy: merge near-duplicates with Jaccard >= 0.80 on
 *      shingled (company + title + primary-location) text.
 *
 ...
 * datasketch production-defaults (128 perms, 18 x 7 bands, Jaccard >= 0.80).
 *
