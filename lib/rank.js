...
// Permissive "this title sounds like ML/AI/DS work" gate. Any one token is
// enough — JD scoring downstream does the real fit assessment.
// Each alternative carries its own \b boundaries so trailing word boundaries
// don't break mid-word (e.g. \bdata scien\b incorrectly fails on "Data Scientist"
// because the \b would land between "n" and "t").
const ML_VOCAB = new RegExp(
  '\\b(?:' + [
    ...
    'machine',                  // catches "Machine Learning Engineer"
    'learning',                 // catches "Deep Learning"
